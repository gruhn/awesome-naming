...
When you add a name or a section make sure to maintain alphabetical order.
...
* argue that a specific entry is not awesome and should be removed
* reorganize entries under new or different sections

## What are awesome names?

There's probably no simple recipe for awesome names.
